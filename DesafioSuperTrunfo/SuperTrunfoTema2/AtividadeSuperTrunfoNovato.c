...
int main() {
    ...
    unsigned long int populacao1, populacao2; // Variáveis para armazenar a população das cidades
    ...
    scanf("%lu", &populacao1); // Lê a população da primeira cidade
    ...
    printf("Digite a população: ");
    scanf("%lu", &populacao2); // Lê a população da segunda cidade
    printf("Digite a área (em km²): ");
    ...
    // Escolha do atributo para comparação (no código, escolhemos 'população')
    ...
    if (atributo == 1) {  // Comparação de População
    ...
    else if (atributo == 2) {  // Comparação de Área
    ...
    else if (atributo == 3) {  // Comparação de PIB
    ...
    else if (atributo == 4) {  // Comparação de Densidade Populacional
    ...
    else if (atributo == 5) {  // Comparação de PIB per Capita
